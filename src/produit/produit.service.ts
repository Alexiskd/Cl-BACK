...
export class ProduitService {
  ...
  // Recherche flexible pour trouver la meilleure correspondance (recherche par LIKE)
  async findBestKeyByName(nom: string): Promise<CatalogueCle> {
    ...
    // Calcul de la distance de Levenshtein pour trier les résultats et obtenir la meilleure correspondance
